  ...
  <div>
    <div class="page-header page-header-small">
      <parallax
        ...
        style="background-image: url('./../../public/img/bg6.jpg')"
      >
      </parallax>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div
                ...
                style="background-image: url('./../../public/img/bg3.jpg')"
              ></div>
            </div>
            <div class="col-md-5">
        ...
        <div class="team">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="team-player">
                <img
                  src="./../../public/img/ryan.jpg"
                  alt="Thumbnail Image"
                  class="rounded-circle img-fluid img-raised"
                />
                <h4 class="title">gsx</h4>
            ...
            <div class="col-md-3">
              <div class="team-player">
                <img
                  src="./../../public/img/eva.jpg"
                  alt="Thumbnail Image"
                  class="rounded-circle img-fluid img-raised"
                />
                <h4 class="title">tzx</h4>
